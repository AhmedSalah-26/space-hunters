    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      ...
      >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm sm:text-base font-black text-white flex items-center gap-2">
                ...
                <span className="text-xs text-emerald-300 font-mono px-2 py-0.5 bg-emerald-950 border border-emerald-500/40 rounded-lg">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-4 space-y-4">
          ...
          {/* Hero Concept Banner */}
          <div className="p-3.5 bg-gradient-to-r from-blue-950/70 via-[#071e3d] to-[#041226] border border-cyan-400/40 rounded-xl flex items-center gap-3.5 shadow-md">
