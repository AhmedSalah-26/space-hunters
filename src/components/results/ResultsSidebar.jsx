...
export default function ResultsSidebar({ mission, activeSideTab, setActiveSideTab }) {
  ...
  return (
    <div
      className="lg:col-span-3 p-3.5 bg-[#061633]/96 border border-cyan-400/40 shadow-2xl backdrop-blur-md flex flex-col gap-2.5 min-h-0 overflow-y-auto custom-scrollbar rounded-xl"
      style={{
