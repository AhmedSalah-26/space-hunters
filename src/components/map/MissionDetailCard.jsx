    ...
    >
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <div
              key={l}
              className={`flex flex-col items-center p-2 ${bg} border ${border} text-center`}
              style={{
                clipPath: 'polygon(8px 0, calc(100% - 8px) 0, 100% 8px, 100% calc(100% - 8px), calc(100% - 8px) 100%, 8px 100%, 0 calc(100% - 8px), 0 8px)',
              }}
            >
              <div>{icon}</div>
              <span className={`text-sm font-black leading-tight ${vc} mt-1`}>{v}</span>
              <p className="text-[9.5px] text-slate-300 font-bold leading-tight truncate w-full mt-0.5">{l}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 mt-1">
        <button
          ...
          className="w-full py-2.5 px-4 font-black text-sm text-white flex items-center justify-center gap-2 transition-all hover:scale-[1.01] active:scale-[0.98] cursor-pointer shadow-lg"
          style={{
            clipPath: 'polygon(8px 0, calc(100% - 8px) 0, 100% 8px, 100% calc(100% - 8px), calc(100% - 8px) 100%, 8px 100%, 0 calc(100% - 8px), 0 8px)',
            background: 'linear-gradient(90deg, #2563eb 0%, #3b82f6 50%, #06b6d4 100%)',
            boxShadow: '0 3px 16px rgba(59,130,246,0.6)',
          }}
        >
        ...
        <button
          onClick={onStartMission}
          className="w-full py-2 px-3 font-bold text-xs text-slate-300 flex items-center justify-center gap-1.5 border border-cyan-500/35 hover:border-cyan-400 hover:text-white bg-white/[0.04] transition-all cursor-pointer"
          style={{
            clipPath: 'polygon(8px 0, calc(100% - 8px) 0, 100% 8px, 100% calc(100% - 8px), calc(100% - 8px) 100%, 8px 100%, 0 calc(100% - 8px), 0 8px)',
          }}
        >
